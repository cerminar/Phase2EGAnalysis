...
if doCompositeTkEle:
    ...
    process.l1tLayer1HGCal.tkEgAlgoParameters.trkQualityPtMin = 0.
else:
    process.l1tLayer1HGCal.tkEgAlgoParameters.doCompositeTkEle = False
    process.l1tLayer1HGCal.tkEgAlgoParameters.trkQualityPtMin = 10.
