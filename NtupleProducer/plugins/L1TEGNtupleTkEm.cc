...
class L1TEGNtupleTkEm : public L1TEGNtupleBase {
public:
  L1TEGNtupleTkEm(const edm::ParameterSet& conf);
  ~L1TEGNtupleTkEm() override{};
...
void L1TEGNtupleTkEm::initialize(TTree& tree,
...
void L1TEGNtupleTkEm::fill(const edm::Event& e, const edm::EventSetup& es) {
  // retrieve towers
